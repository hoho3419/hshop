...
const ContactForm = () => {
    ...
    const submitForm = (e:any) => {
        e.preventDefault()
        return toast.info(`${name}님 폼 처리가 아직 구현되지 않았습니다`, {
            position: 'top-left',
            autoClose: 3000,
            toastId: 'form'
        })
  ...
  return (
    <div className="h-full w-full flex items-center flex-col justify-center px-4 bg-primary">
      ...
      <p className="mb-2 cursor-pointer text-sm text-gray-500 dark:text-gray-400">
        <a href="mailto:hohoho3419@gmail.com" className="hover:underline">
          hohoho3419@gmail.com
        </a>
      </p>
      <p className="text-sm cursor-pointer text-gray-500 dark:text-gray-400">
        <a href="tel:+01023873281" className="hover:underline">
          +010-2387-3281
        </a>
      </p>
    </div>
